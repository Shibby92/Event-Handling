...
/**
 * Klasa u kojoj je event handler napisan kao anonymous klasa koja extenda
 * odgovarajuci event adapter i overrida samo potrebnu metodu.
 * 
 * @author Haris
 *
 */
public class Circle4 {
	...
	public static void main(String[] args) {
		...
		/*
		 * implementacija anonimne klase koja implementira KeyAdapter i
		 * override-a samo keyPressed metodu
		 */
